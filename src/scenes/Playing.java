...
import static helpers.Constants.Tiles.GROUND_TILE;
			...
			if(isAllEnemiesDead()) {
				if(isThereMoreWaves()) {
					...
					if(isWaveTimerOver()) {
						...
						//gold per wave
						actionBar.addGold((int) (500 * 0.5 + waveManager.getWaveIndex() * 0.1) + (10 * (int)(waveManager.getWaveIndex() + 2.5)));
	...
	public void mouseClicked(int x, int y) {
		if (y >= 640) 
			...
			if(selectedTower != null) {
				...
				//tower click in the map then display
